	...
	<div class="bg-bottomnav p-8 grid grid-cols-4 gap-x-10 gap-y-4">
		...
		<div class="text-textmuted font-medium">
			...
			<div class="flex space-x-4 mt-3"><a href="#"
					class="text-gray-400 hover:text-white transition-colors duration-300"><svg
		...
		<div class="mt-10">
			<ul class="flex space-x-6">
				<li v-for="x in p" :key="x"><a href="#"
						class="text-gray-400 hover:text-white transition-colors duration-300 relative group">
						{{ x }}<span
							class="absolute bottom-0 left-0 w-0 h-0.5 bg-white transition-all duration-300 group-hover:w-full"></span></a>
				</li>
...
<script setup>
const quick_links = ['Home', 'Products', 'About Us', 'Blog']
const support = ['Contact Us', 'FAQ', 'Shipping Policy', 'Returns & Refunds']
const headings = ['BD Funnel Builder', 'Quick Links', 'Support', 'Newsletter']
const p = ['Terms of Services', 'Privacy Policy', 'Contact']
</script>
